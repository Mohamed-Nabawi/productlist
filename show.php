...
<h1>Product List</h1>
<div class="c">
  <a href="add.php"><button class="btn btn-primary btn-sm ">ADD</button></a>
...
<form method="post" action="">
 ...
 <div class="product" >
          ...
          <?php echo             $val['SkuID'] . "<br>";?>
          <?php echo             $val['Name'] ."<br>";?>
          <?php echo             $val['Price'] . "$"."<br>";?>
          <?php echo "Weight :" .$val['weight'] ."KG";?>
  ...
  <input type="checkbox" name="Furniture[]" value="<?php echo $val['SkuID'];?>">
          ...
          <?php echo                 $val['Name'] ."<br>";?>
          <?php echo                 $val['Price'] . "$"."<br>";?>
          <?php echo  "Dimensions : "  .$val['width'] . "x" . $val['Length'] ."x" 
          . $val['height'];?> 
  ...
  <div class="ss">
  <button class="btn btn-danger btn-sm"  type="submit"> Mass Delete</button>
