...
<body>
  ...
  <div class="container-sm">
     ...
     <form action=" " method="post" class="form-group">
          Sku  :<input  class="form-control" type="text" id="SkuID"  name="SkuID"  value=" " autocomplete="off" minlength="8" required> <br>
          
          Name  :<input class="form-control" type="text" id="Name"  name="Name" autocomplete="off" value=" "  required><br>
          
          
          Price($) :<input class="form-control" type="number" id="Price"  name="Price"  value=" " required><br>
